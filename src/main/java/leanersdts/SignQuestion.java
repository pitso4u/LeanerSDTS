...
public class SignQuestion implements QuizQuestion {
    ...
    public void setOptions(String[] options) {
        if (options != null && options.length == 3) {
            ...
            System.err.println("SignQuestion:setOptions - Incorrect number of options provided. Expected 3, got " + (options != null ? options.length : "null"));
